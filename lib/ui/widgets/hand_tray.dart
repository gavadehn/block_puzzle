            ...
            Padding(
              ...
              child: AnimatedSwitcher(
                ...
                child: selectedIdx != null
                    ? Row(
                        ...
                        children: [
                          ElevatedButton.icon(
                            ...
                            label: const Text('Xoay Trái', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                          ...
                          ElevatedButton.icon(
                            ...
                            label: const Text('Xoay Phải', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                            style: ElevatedButton.styleFrom(
                              backgroundColor: const Color(0xFF1E2536),
                    ...
                    : const Text(
                        '💡 Chạm vào khối gạch để xoay trước khi kéo thả',
                        key: ValueKey('hint_text'),
                        style: TextStyle(
